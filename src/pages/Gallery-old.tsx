...
import { Heart, Image, Users, UploadCloud } from 'lucide-react';
...
export const Gallery = () => {
    ...
    const navigationItems = useMemo(() => {
        const items = [
            { id: 'live' as PageType, label: 'Álbum ao vivo', icon: Heart },
            { id: 'gallery' as PageType, label: 'Todas as fotos', icon: Image, count: photos.length },
        ];
        
        if (isPrivileged) {
            items.push({ id: 'insights' as PageType, label: 'Convidados', icon: Users, count: guests.length });
        }
